...
const Controls = ({
  ...
  <div className="absolute -top-5 lg:top-5 left-2/4 lg:left-1/4 transform -translate-x-2/4 flex justify-center items-center m-auto bg-purple-200 rounded-3xl shadow-2xl z-50">
    <motion.div
      role="button"
      tabIndex={0}
